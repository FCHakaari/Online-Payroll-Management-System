                    ...
                    <div class="card">
                            ...
                            <?php
                                ...
                                if ($status) {
                                    while ($row = mysqli_fetch_assoc($status)) {
                                        echo "<h1>";
                                        echo "<h1><center><marquee><font face='Lucida Console' color='FireBrick'><td>&nbsp;С ДНЕМ РОЖДЕНИЯ<br></font><img src='cake.png' style='width:100px;height:80px;'><font color='DarkMagenta'> ".$row['Employee_name']."<img src='cake.png' style='width:100px;height:80px;'></h1></marquee></center></font></td>";
                                    }
                                }
                                ...
                                if ($sts9) {
                                    ...
                                    if (isset($sts['Status'])) {
                                        ...
                                        if ($sts8 == 0) {
                                            $cnt8 = "отпуск в ожидании";
                                        } elseif ($sts8 == 1) {
                                            $cnt8 = "отпуск утвержден";
                                        } elseif ($sts8 == 2) {
                                            $cnt8 = "отпуск отклонен";
                                        } else {
                                            $cnt8 = "неизвестный статус";
                                        }
                                    } else {
                                        $cnt8 = "статус не найден";
                                    }
                                } else {
                                    $cnt8 = "ошибка при получении статуса";
                                }
                            ?>
                            <hr>
                        </div>
                        ...
                        <div>
                                ...
                                <div class="info-box bg-purple">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="number count-to" data-from="0" data-to="117" data-speed="1000"
                                            data-fresh-interval="20"><?php echo $cnt5; ?></div>
                                    </div>
                                </div>
                            </div>
                            <br><br><br><br><br><br>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="info-box bg-red">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="number count-to" data-from="0" data-to="117" data-speed="1000"
                                            data-fresh-interval="20"><?php echo $cnt7; ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="info-box bg-grey">
                                    ...
                                    <div class="content">
                                        <div class="text">ОТПУСКИ</div>
                                        <div class="number count-to" data-from="0" data-to="117" data-speed="1000"
                                            data-fresh-interval="20"><?php echo $cnt8; ?></div>
                                    </div>
                                </div>
                            </div>
                            <br><br><br><br><br><br>
                        ...
                        <div style="margin-top:-300px ">
                            ...
                            function drawTime(ctx, radius) {
                                ...
                                hour = hour % 12;
                                hour = (hour * Math.PI / 6) + (minute * Math.PI / (6 * 60)) + (second * Math.PI / (360 *
                                    60));
