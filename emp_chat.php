                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            ...
                            $q = "SELECT * FROM employee"; // Здесь также будут приходить данные из других таблиц для различных ID

                            echo "<table class='table table-bordered' border='0' align='center'>";
                            echo "<thead>";
                            echo " <tr>";
                            echo "  <th>ИМЯ СТРУДНИКА</th>";
                            echo "  <th>ЧАТ</th>";
                            echo " </tr>";
                            echo "</thead>";
                            echo "<tbody>";
                                    ...
                                    if ($_SESSION['employee_id'] != $row['Employee_id']) {
                                        ...
                                        if ($status1) {
                                            ...
                                            if ($cnt > 0) {
                                                ?>
                            <div
                                style="background: lightgreen; border-radius: 80px; height: 20px; width: 20px; margin-left: 60px; margin-top: -35px;">
