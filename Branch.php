                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <h2 class="card-inside-title">Название филиала:</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                            ...
                            <h2 class="card-inside-title">Адрес филиала:</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="4" class="form-control no-resize"
                                                name="branchaddress"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h2 class="card-inside-title">Номер телефона:</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                            ...
                            <h2 class="card-inside-title">Дата основания:</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                            ...
                            <h2 class="card-inside-title">Создано пользователем:</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                        ...
                        <center>
                            <input class="btn btn-primary waves-effect" name="submit" type="submit" value="ОТПРАВИТЬ">
