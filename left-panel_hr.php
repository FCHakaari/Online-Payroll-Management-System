...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= ADMIN_URL ?>dashbord.php">Система учета сотрудников ГБ №2</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li><a href="<?= ADMIN_URL ?>employee_profile.php"><i class="material-icons">person</i>Просмотреть свой профиль</a></li>
                        <li><a href="<?= ADMIN_URL ?>change_pwd.php"><i class="material-icons">create</i>Сменить пароль</a></li>
                        <li><a href="<?= ADMIN_URL ?>logout.php"><i class="material-icons">input</i>Выйти</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <ul class="list">
                ...
                <li>
                    <a href="<?= ADMIN_URL ?>Accept_Reject.php">
                        ...
                        <span>УТВЕРДИТЬ/ОТКЛОНИТЬ ОТПУСКИ</span>
                    </a>
                </li>
                <li>
        ...
        <div class="legal">
            <div class="copyright">
                © 2023 <a href="<?= ADMIN_URL ?>dashbord.php">Система учета зарплаты сотрудников<br>
                    с приложением чата</a>.
            </div>
        </div>
    </aside>
</section>